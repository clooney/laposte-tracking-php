...
$extraInfo['lang']                 = 'en';
$track = $track->createTracking('laposte','6A15651349859',$extraInfo);

//4 List all trackings (列出多个物流信息)
//$track = $track->getTrackingsList($numbers = "6A15651349859",$orders = "",$page = 1,$limit = 100,$createdAtMin = 0,$createdAtMax = 0,$update_time_min = 0,$update_time_max = 0,$order_created_time_min = 0,$order_created_time_max = 0,$lang = "en");

//5 Get tracking results of a single tracking (列出单个运单号物流信息)
//$track = $track->getSingleTrackingResult("laposte","6A15651349859",'en');

//6 create muti tracking number (创建多个运单号)
//$items = array(
//    array(
//        'tracking_number' => '6A15651349859',
...
//$extraInfo['destination_code'] = 'US';
//$extraInfo['status']       = '7';
//$track = $track->updateTrackingItem('laposte','6A15651349859',$extraInfo);

//8 Delete a tracking item (删除单个运单号)
//$track = $track->deleteTrackingItem('laposte','6A15651349859');

//9 Get realtime tracking results of a single tracking (获取单个运单号实时物流信息)
// $track = $track->getRealtimeTrackingResults("laposte","6A15651349859",array("lang"=>'en'));

//10 Modify courier code (修改运输商简码)
//$r = $track->updateCarrierCode("6A15651349859","laposte","china-ems");
...
//$date = array();
//$data[] = array("tracking_number"=>"6A15651349859","carrier_code"=>"laposte");
...
//$data = array();
//$data[] = array("original"=>"CN","destination"=>"US","carrier_code"=>"laposte");
